...
set -e
echo "=============================================="
echo " ROSE-REC Automation Installer v5"
echo " (RECORD-only scan + day-folder grouping)"
echo "=============================================="
...
#!/bin/bash
# ROSE-REC Recording Auto-Upload Watcher (v5)
...
for DEVICE in "${DEVICES[@]}"; do
    ...
    while IFS= read -r -d '' FILE; do
        ...
        case "$PARENT" in
            RECORD|RECORDINGS|RECORDING|VOICE|REC|AUDIO)
